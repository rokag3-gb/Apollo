...
def main():
    ...
    with open('Apollo.ML/artifacts/RLQO/configs/v3_action_space.json', 'r') as f:
        actions = json.load(f)
    
    with open('Apollo.ML/artifacts/RLQO/configs/v3_query_action_compatibility.json', 'r') as f:
    ...
    cache_file = os.path.join(cache_dir, 'v3_plan_cache.pkl')
    with open(cache_file, 'wb') as f:
        pickle.dump(plan_cache, f)
    
    # 난이도 정보 저장
    difficulty_file = os.path.join(cache_dir, 'v3_query_difficulties.json')
