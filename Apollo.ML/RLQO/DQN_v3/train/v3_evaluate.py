# -*- coding: utf-8 -*-
"""
DQN v3: 포괄적 성능 평가 스크립트
================================
DQN v3 모델의 성능을 평가합니다.
...
def compare_models(models_to_evaluate, mode='full'):
    ...
    if all_summaries:
        ...
        results_file = f"Apollo.ML/artifacts/RLQO/evaluation_results_v3_{timestamp}.csv"
        summary_file = f"Apollo.ML/artifacts/RLQO/evaluation_summary_v3_{timestamp}.csv"
...
def main():
    ...
    parser = argparse.ArgumentParser(description='DQN v3 모델 평가')
    ...
    # 평가할 모델 목록 (v3 모델만)
    models_to_evaluate = [
        ('Apollo.ML/artifacts/RLQO/models/dqn_v3_sim.zip', 'DQN v3 Sim'),
        ('Apollo.ML/artifacts/RLQO/models/dqn_v3_final.zip', 'DQN v3 Final'),
    ]
    ...
    if not existing_models:
        print("[ERROR] No v3 models found for evaluation!")
