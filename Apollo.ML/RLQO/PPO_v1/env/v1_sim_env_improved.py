...
기존 v3 시뮬레이션 환경을 확장하여:
- Query 타입 자동 분류
- 타입별 보상 함수 적용
- 보수적 정책 옵션 (안전한 액션만 허용)
"""
...
class QueryPlanSimEnvV1Improved(QueryPlanSimEnvV3):
    """
    PPO v1 개선 시뮬레이션 환경
    ...
    def __init__(self, 
        ...
        if self.verbose:
            print(f"[INFO] PPO v1 Improved Environment initialized")
...
if __name__ == '__main__':
    print("=== PPO v1 Improved Simulation Environment 테스트 ===\n")
