# -*- coding: utf-8 -*-
"""
DQN v4: 개선된 실제 DB 환경 (constants2.py 기반 30개 쿼리)
- 액션 호환성 체크 및 마스킹
...
class QueryPlanDBEnvV4(gym.Env):
    """
    DQN v4용 실제 DB 환경 (constants2.py 기반 30개 쿼리)
    - 액션 호환성 체크 및 마스킹
    - 베이스라인 시간 기반 Curriculum Learning
    - TABLE_HINT 구현
    - v4 보상 함수 적용
    ...
    def step(self, action_id):
        ...
        if next_obs is None:
            ...
            # 5. 보상 계산 (v4: invalid_action=False)
...
if __name__ == '__main__':
    print("=== DQN v4 DB Environment 테스트 ===\n")
