# -*- coding: utf-8 -*-
"""
DQN v4: 개선된 보상 함수 (constants2.py 기반 30개 쿼리)
v3의 보상 함수를 기반으로 다음 요소를 유지:
...
def calculate_reward_v4(
    ...
    """
    v4 보상 함수: elapsed_time 0.7 + logical_reads 0.3 가중치 적용
...
def calculate_reward_simple_v4(metrics_before: dict, metrics_after: dict) -> float:
    """
    간단한 보상 함수 (v4 버전)
