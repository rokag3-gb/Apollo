# -*- coding: utf-8 -*-
"""
DQN v3: Sim-to-Real 하이브리드 학습 파이프라인
==============================================
...
SIM_LOG_DIR = f"{BASE_DIR}logs/dqn_v3_sim/"
SIM_MODEL_PATH = f"{BASE_DIR}models/dqn_v3_sim.zip"
SIM_CHECKPOINT_DIR = f"{BASE_DIR}models/checkpoints/dqn_v3_sim/"

REAL_LOG_DIR = f"{BASE_DIR}logs/dqn_v3_real/"
REAL_MODEL_PATH = f"{BASE_DIR}models/dqn_v3_final.zip"
REAL_CHECKPOINT_DIR = f"{BASE_DIR}models/checkpoints/dqn_v3_real/"

TB_LOG_DIR = f"{BASE_DIR}tb/dqn_v3/"
...
def train_phase_simulxgb():
    ...
    try:
        env = QueryPlanSimEnvV3(
            ...
            max_steps=10,
            cache_path='Apollo.ML/artifacts/RLQO/cache/v2_plan_cache.pkl',  # 임시로 v2 캐시 사용
...
def main():
    ...
    parser = argparse.ArgumentParser(description='DQN v3 하이브리드 학습 파이프라인')
