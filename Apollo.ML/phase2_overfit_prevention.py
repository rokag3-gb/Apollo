...
def main():
    ...
    # 모델 저장
    import joblib
    joblib.dump(results['model'], 'artifacts/phase2_overfit_prevention_model.joblib')
    joblib.dump(results['scaler'], 'artifacts/phase2_overfit_prevention_scaler.joblib')
    results['feature_importance'].to_csv('artifacts/phase2_overfit_prevention_importance.csv', index=False)
    
    print(f"\n모델 저장 완료: artifacts/phase2_overfit_prevention_model.joblib")
